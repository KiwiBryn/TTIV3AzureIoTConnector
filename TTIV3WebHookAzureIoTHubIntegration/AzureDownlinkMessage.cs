...
namespace devMobile.IoT.TheThingsIndustries.AzureIoTHub
{
	...
	public class AzureDownlinkMessage
	{
		...
		public static bool PriorityTryGet(IDictionary<string, string> properties, out Models.DownlinkPriority priority)
		{
			priority = Models.DownlinkPriority.Normal;
			...
			if (!Enum.TryParse(properties["Priority"], true, out priority) || !Enum.IsDefined(typeof(Models.DownlinkPriority), priority))
			{
				return false;
			}
		...
		public static bool QueueTryGet(IDictionary<string, string> properties, out Models.DownlinkQueue queue)
		{
			queue = Models.DownlinkQueue.Push;
			...
			if (!Enum.TryParse(properties["Queue"], true, out queue) || !Enum.IsDefined(typeof(Models.DownlinkQueue), queue))
			{
				return false;
			}
